            ...
            <div class="container">
                <div class="row">               
                    ...
                    <!-- <div class="col-md" id="oo">
                        <div class="vision-img"><img src="/Images/services-waste.png" alt=""></div>
                    </div> -->
                    <div class="col-md align-self-center" id="pp">
                        <div class="services-wrap wow animate__animated animate__fadeInUp">
                            <h3>Waste Management</h3>
                            <p class="text-justify">Waste management is intended to reduce adverse effects of waste on human health and environment.
                                Nibram Cleaning Services provides comprehensive waste management Service, offering services such as 
                                garbage collection and disposal, recycling and dumpster rental.
                                <span>Our Waste Management services</span>
                                <ul>
