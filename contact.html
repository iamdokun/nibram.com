                ...
                <div class="row pt-3 pb-3">
                    <div class="col-md  pt-5" id="nn">
                        <div class="contact pl-lg-2">
                            ...
                            <form action="" class="wow animate__animated animate__fadeInLeft">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="08023543311"
                                        required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Email address</label>
                                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="john.smith@abc.com"
                                        required>
                                </div>
                                <div class="mb-3">
