    ...
    <main>
        ...
        <section class="vision-wrap">
            <div class="container">
                <div class="row">                
                    <div class="w-100"></div>
                    <!-- <div class="col-md align-self-center" id="oo">
                        <div class="vision-img"><img src="/Images/services-genClean.png" alt=""></div>
                    </div> -->
                    <div class="col-md " id="pp">
                        <div class="services-wrap wow animate__animated animate__fadeInUp">
                            <h3>General Cleaning</h3>
                            <p class="text-justify">Cleanliness plays large role in the comfort of your resident and business space, but many at times 
                                we simply don’t have the luxury of time to complete this task due to busy lifestyles. 
                                At Nibram Cleaning Services, We possess all the required human & materials resources to deliver 
                                efficient cleaning services to meet your needs. we recognize that a clean resident/business space gives great comfort 
                                and a productive environment, which is why we are proud to offer comprehensive 
                                cleaning service.
                                We provide one-time, monthly or quarterly Cleaning Services.

                                <span>Our General Cleaning Service</span>
                                <ul>
                                    <li>Residential Cleaning</li>
                                    <li>Office / Hospital / Hotel Cleaning </li>
                                    <li>Industrial / Factory Cleaning</li>
                                    <li>Post Construction Cleaning</li>
                                    <li>Pre/After Events cleaning </li>
